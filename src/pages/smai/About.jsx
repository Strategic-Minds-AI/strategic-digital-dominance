    ...
    <div className="min-h-screen bg-stone-950">
      ...
      <section className="border-b border-stone-800 bg-gradient-to-b from-stone-900/50 to-stone-950">
        <div className="max-w-7xl mx-auto px-6 py-16 md:py-20">
          <p className="font-mono text-[10px] tracking-[0.3em] text-amber-500 uppercase mb-3">— ABOUT US —</p>
      ...
      <section className="bg-white py-16 md:py-20 border-b border-stone-200">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            <p className="font-mono text-[10px] tracking-[0.3em] text-amber-600 uppercase mb-3">— OUR STORY —</p>
          ...
          <div className="rounded-2xl border border-stone-200 bg-gradient-to-br from-stone-50 to-white p-8">
            <div className="grid grid-cols-2 gap-6">
              <div className="text-center"><div className="text-4xl font-black bg-gradient-to-r from-amber-500 to-amber-700 bg-clip-text text-transparent">50+</div><div className="text-xs text-stone-500 mt-1 uppercase tracking-wide">AI Systems Deployed</div></div>
              <div className="text-center"><div className="text-4xl font-black bg-gradient-to-r from-amber-500 to-amber-700 bg-clip-text text-transparent">3x</div><div className="text-xs text-stone-500 mt-1 uppercase tracking-wide">Avg. Revenue Lift</div></div>
              <div className="text-center"><div className="text-4xl font-black bg-gradient-to-r from-amber-500 to-amber-700 bg-clip-text text-transparent">24/7</div><div className="text-xs text-stone-500 mt-1 uppercase tracking-wide">Agent Uptime</div></div>
              <div className="text-center"><div className="text-4xl font-black bg-gradient-to-r from-amber-500 to-amber-700 bg-clip-text text-transparent">90%</div><div className="text-xs text-stone-500 mt-1 uppercase tracking-wide">Client Retention</div></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-white py-16 md:py-20 border-b border-stone-200">
        <div className="max-w-7xl mx-auto px-6">
          <p className="font-mono text-[10px] tracking-[0.3em] text-amber-600 uppercase mb-3 text-center">— WHAT WE STAND FOR —</p>
          <h2 className="text-3xl font-black text-stone-950 mb-10 text-center">Our Core Values</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
            {VALUES.map((v) => (
              <div key={v.title} className="rounded-2xl border border-stone-200 bg-stone-50 p-6 hover:border-amber-400 hover:shadow-lg transition">
                <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-amber-300 to-amber-600 flex items-center justify-center mb-4 shadow-md shadow-amber-500/20">
      ...
      <section className="bg-stone-950 border-y border-stone-800 py-16">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div>
            <p className="font-mono text-[10px] tracking-[0.3em] text-amber-500 uppercase mb-3">— OUR INFRASTRUCTURE —</p>
      ...
      <section className="bg-white py-16 md:py-20 border-b border-stone-200">
        <div className="max-w-7xl mx-auto px-6">
          <p className="font-mono text-[10px] tracking-[0.3em] text-amber-600 uppercase mb-3 text-center">— OUR JOURNEY —</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {TIMELINE.map((t) => (
              <div key={t.year} className="rounded-2xl border border-stone-200 bg-stone-50 p-6">
                <div className="text-3xl font-black bg-gradient-to-r from-amber-500 to-amber-700 bg-clip-text text-transparent mb-2">{t.year}</div>
