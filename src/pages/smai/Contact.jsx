            ...
            {submitted ? (
              <div className="rounded-2xl border border-amber-500/30 bg-amber-500/5 p-10 text-center">
                ...
                <p className="text-stone-400 mb-6">
                  We've received your message and will reach out within 24 hours to schedule your strategy call.
                </p>
                <button
              ...
              <form onSubmit={handleSubmit} className="rounded-2xl border border-stone-800 bg-stone-900/50 p-7 md:p-8 space-y-5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full h-11 rounded-lg border border-stone-700 bg-stone-950 px-4 text-sm text-white outline-none focus:border-amber-500 transition"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={5}
                    className="w-full rounded-lg border border-stone-700 bg-stone-950 px-4 py-3 text-sm text-white outline-none focus:border-amber-500 transition resize-none"
                    placeholder="Tell us about your business, goals, and what you'd like to achieve with AI..."
                  />
                </div>
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="w-full h-12 rounded-xl bg-gradient-to-r from-amber-400 to-amber-600 text-stone-950 font-bold hover:from-amber-300 hover:to-amber-500 transition shadow-lg shadow-amber-500/20 disabled:opacity-50 flex items-center justify-center gap-2"
                >
                  {submitting ? (
          ...
          <div className="lg:col-span-2 space-y-5">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <a href="mailto:hello@strategicmindsai.com" className="text-sm text-white hover:text-amber-400 transition">hello@strategicmindsai.com</a>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-10 h-10 rounded-lg bg-amber-500/10 border border-amber-500/30 flex items-center justify-center shrink-0">
            ...
            <div className="rounded-2xl border border-amber-500/20 bg-amber-500/5 p-7">
              ...
              <ol className="space-y-2.5 text-sm text-stone-400">
                <li className="flex gap-2.5"><span className="text-amber-500 font-bold">1.</span> We review your message within 24 hours</li>
                <li className="flex gap-2.5"><span className="text-amber-500 font-bold">2.</span> We schedule a 30-min strategy call</li>
                <li className="flex gap-2.5"><span className="text-amber-500 font-bold">3.</span> We deliver a custom AI opportunity audit</li>
                <li className="flex gap-2.5"><span className="text-amber-500 font-bold">4.</span> You decide if we're a fit — no pressure</li>
              </ol>
            </div>
          </div>
        </div>
