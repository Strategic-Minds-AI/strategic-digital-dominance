    ...
    <header className="sticky top-0 z-50 bg-stone-950/95 backdrop-blur border-b border-stone-800">
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        <Link to="/smai" className="flex items-center gap-2.5 group">
          <div className="w-9 h-9 rounded-lg bg-gradient-to-br from-amber-300 via-amber-500 to-amber-700 flex items-center justify-center shadow-lg shadow-amber-500/20">
        ...
        <nav className="hidden md:flex items-center gap-1">
          ...
          <Link
            to="/smai/contact"
            className="ml-2 px-5 py-2 rounded-lg text-sm font-bold bg-gradient-to-r from-amber-400 to-amber-600 text-stone-950 hover:from-amber-300 hover:to-amber-500 transition shadow-lg shadow-amber-500/20"
          >
            Book a Call
          </Link>
        </nav>
          ...
          {LINKS.map((l) => (
            <Link
              ...
              className={`block px-4 py-3 rounded-lg text-sm font-medium ${
                pathname === l.to ? "text-amber-400 bg-amber-500/10" : "text-stone-400 hover:text-white hover:bg-white/5"
              }`}
            >
              {l.label}
            </Link>
